...
Этот репозиторий содержит все темы, которые могут быть использованы пользователями инстанса.
...
## Как добавить тему в этот репозиторий?

Для темы достаточно css и yml-файла. Добавьте директорию с темой в директорию репозитория и внесите в `.gitignore`, по аналогии с другими строками, папку с темой. Затем добавьте упоминание в `THEMES.md`.
